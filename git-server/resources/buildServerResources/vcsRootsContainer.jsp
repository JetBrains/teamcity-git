...
<bs:refreshable containerId="testConnectionVcsRootsContainer" pageUrl="${controllerUrl}">
  <admin:vcsRootChooser chooserName="testConnectionVcsRoots" headerOption="-- Choose VCS roots to run Test Connection --" attachableRoots="${projectGitRoots}" multiple="multiple" onchange="return true;"/>
</bs:refreshable>