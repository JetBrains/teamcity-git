...
<table class="runnerFormTable">
  ...
  <l:settingsGroup title="General Settings">
    <tr>
      ...
      <td><props:textProperty name="url" className="longField" disabled="${readOnly}"/>
    ...
    <tr class="advancedSetting">
      ...
      <td><props:textProperty name="push_url" className="longField" disabled="${readOnly}"/>
    ...
    <tr class="advancedSetting">
      ...
      <td>
        <props:checkboxProperty name="reportTagRevisions" disabled="${readOnly}"/>
    ...
    <tr class="advancedSetting">
      ...
      <td><props:selectProperty name="usernameStyle" enableFilter="true" className="mediumField" disabled="${readOnly}">
    ...
    <tr class="advancedSetting">
      ...
      <td><props:selectProperty name="submoduleCheckout" enableFilter="true" className="mediumField" disabled="${readOnly}">
  ...
  <l:settingsGroup title="Authentication Settings">
    <tr>
      ...
      <td>
        <props:selectProperty name="authMethod" onchange="gitSelectAuthentication(true)" enableFilter="true" className="mediumField" disabled="${readOnly}">
        ...
        <div id="customKeyNote" class="smallNote auth customKey" style="margin: 0">
          Custom keys work only with server-side checkout. <bs:help file="SSH+Keys+Management#Configure+VCS+Root+Settings" preservePlus="true"/>
        </div>
      </td>
    </tr>
    <tr id="gitUsername" class="auth defaultKey customKey password uploadedKey access_token">
      <th><label for="username">Username:</label></th>
      <td><props:textProperty name="username" className="longField" disabled="${readOnly}"/>
        <div class="smallNote" style="margin: 0">
    ...
    <tr id="gitPrivateKeyRow" class="auth customKey">
      ...
      <td><props:textProperty name="privateKeyPath" className="longField" disabled="${readOnly}"/>
        <div class="smallNote" style="margin: 0;">
    ...
    <tr id="gitPassphraseRow" class="auth customKey">
      ...
      <td><props:passwordProperty name="secure:passphrase" className="longField" disabled="${readOnly}"/></td>
    </tr>
    <c:choose>
      <c:when test="${showKnownHostsDbOption or not vcsPropertiesBean.propertiesBean.properties['ignoreKnownHosts']}">
        <tr id="gitKnownHosts" class="advancedSetting">
          <div class="auth defaultKey customKey uploadedKey">
            ...
            <td><props:checkboxProperty name="ignoreKnownHosts" disabled="${readOnly}"/>
  ...
  <l:settingsGroup title="Server Settings" className="advancedSetting">
    ...
    <c:if test="${showCustomClonePath}">
      <tr class="advancedSetting">
        ...
        <td><props:textProperty name="path" className="longField" disabled="${readOnly}"/>
          <div class="smallNote" style="margin: 0;">
  ...
  <l:settingsGroup title="Agent Settings" className="advancedSetting">
    ...
    <tr class="advancedSetting">
      ...
      <td><props:textProperty name="agentGitPath" className="longField" disabled="${readOnly}"/>
        <div class="smallNote" style="margin: 0;">
    ...
    <tr class="advancedSetting">
      ...
      <td>
        ...
        <props:selectProperty name="useAlternates" enableFilter="true" className="mediumField" onchange="updateCheckoutTypeNote()" disabled="${readOnly}">
    ...
    <tr class="advancedSetting">
      ...
      <td><props:selectProperty name="agentCleanPolicy" enableFilter="true" className="mediumField" disabled="${readOnly}">
    ...
    <tr class="advancedSetting">
      ...
      <td><props:selectProperty name="agentCleanFilesPolicy" enableFilter="true" className="mediumField" disabled="${readOnly}">
