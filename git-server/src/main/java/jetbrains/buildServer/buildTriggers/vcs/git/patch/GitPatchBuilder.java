...
public class GitPatchBuilder {
  ...
  private void addToCommitTree() throws IOException, VcsException {
    ...
    myContext.addTree(myGitRoot, myTreeWalk, myRepository, toCommit, null, false, true, myRules);
  }
  ...
  private void addFromCommitTree() throws IOException, VcsException {
    if (myFullCheckout) {
      ...
      if (fromCommit == null) {
        ...
        myContext.addTree(myGitRoot, myTreeWalk, myRepository, fromCommit, null, true, true, myRules);
      }
    }
  }
