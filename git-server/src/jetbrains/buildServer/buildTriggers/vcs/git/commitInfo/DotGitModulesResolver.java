...
*/
public class DotGitModulesResolver {
  private static final Logger LOG = Logger.getInstance(DotGitModulesResolver.class.getName());

  private final Repository myDb;

  public DotGitModulesResolver(@NotNull final Repository db) {
    myDb = db;
  }
