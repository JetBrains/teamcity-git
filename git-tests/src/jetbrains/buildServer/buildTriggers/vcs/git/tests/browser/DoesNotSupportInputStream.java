 ...
 */
public class DoesNotSupportInputStream extends TypeSafeMatcher<Element> {
  ...
  public static DoesNotSupportInputStream doesNotSupportInputStream() {
    return new DoesNotSupportInputStream();
  }
}
