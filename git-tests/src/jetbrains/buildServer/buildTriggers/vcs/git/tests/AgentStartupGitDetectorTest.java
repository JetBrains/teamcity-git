...
public class AgentStartupGitDetectorTest {
  ...
  public void setUp() {
    ...
    myContext.checking(new Expectations(){{
      exactly(1).of(extensionHolder).registerExtension(with(AgentConfigurationSnapshot.class), with(AgentStartupGitDetector.class.getName()), with(aNonNull(AgentStartupGitDetector.class)));
    }});
  ...
  public void should_do_nothing_if_path_to_git_set_by_user() {
    ...
    myDetector.addParameters(new HashMap<>());
