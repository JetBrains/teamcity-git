...
import jetbrains.buildServer.buildTriggers.vcs.git.command.impl.UnixScriptGen;
import jetbrains.buildServer.buildTriggers.vcs.git.command.impl.WinScriptGen;
